...
Here we use the R package [Signac](https://stuartlab.org/signac/) to processing scATAC-seq peak data. The example data has been updated to [Zenodo](https://zenodo.org/records/15621738).
