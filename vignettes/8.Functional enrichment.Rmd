...
# In this case, we perform a very simple wilcoxon rank-sum test to identify differnetially enriched hallmarks.
test.res <- data.frame()
...
knitr::include_graphics("https://www.helloimg.com/i/2025/02/25/67bd7ef571ee7.png")
```